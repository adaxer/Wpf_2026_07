...
//{
//    public DesignMainViewModel() : base(new DesignStatusBarViewModel(), new DocumentListViewModel(new PdfDocumentService(), new WpfPubSubService()), new ModuleHostViewModel(new WpfPubSubService()), new ToolBarViewModel(), new WpfPubSubService())
//    {
//    }
//}
